...
export default function ItemSocialMedia(props) {
  return (
    <div className="flex flex-col">
      <h1 className="text-2xl text-secondary text-center">REDES SOCIAIS</h1>
      <div className="presentation__socialmedia_icons">
        <a
          href="https://www.instagram.com/symcomp.imeusp?igsh=MTYybmM0eTBicjh3cQ=="
          target="_blank"
        >
          <div>
        ...
        <a
          href="https://www.linkedin.com/in/semana-da-computa%C3%A7%C3%A3o-ime-usp-00420828a/"
          target="_blank"
        >
          <div>
