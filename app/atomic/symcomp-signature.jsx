...
export default function SymcompSignature () {
    return (
        <div className="symcomp-signature__container">
            <svg className="symcomp-signature__logo" version="1.0" xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
                <div className="symcomp-signature__title" >SYMCOMP</div>
                <div className="symcomp-signature__subtitle">SIMPÓSIO DA COMPUTAÇÃO</div>
            </div>
        </div>
    )
}