...
export default function About () { 
    return (
        <div className="about">
            <h1 className="schedule__title titles">QUEM SOMOS?</h1>
            ...
            <div className="patrocinadores_button">
                <a href="https://docs.google.com/forms/d/e/1FAIpQLScfeIl-0kHcDKvJK6gJd7aTdoLOALBxQZUdMu-80L-2F4Iwcw/viewform?usp=sf_link" target="_blank">
