...
export default function Nav() {
  ...
  return (
    <div className="flex flex-row px-4 py-4 bg-primary overflow-auto">
      <ItemNav
        navigateTo="inicio"
        innerText="início"
        selected={inicio}
      ...
      <ItemNav
        ...
        innerText="cronograma"
        selected={cronograma}
        onClick={handleClickCronograma}
      />
      <ItemNav
        navigateTo="patrocinadores"
        innerText="Patrocinadores"
        selected={patrocinadores}
        onClick={handleClickPatrocinadores}
      />
      <ItemNav
        navigateTo="quem-somos"
        innerText="Quem Somos?"
        selected={quemSomos}
        onClick={handleClickQuemSomos}
      />
      <ItemNav
        navigateTo="faq"
        innerText="FAQ"
      ...
      />
      <ItemNav
        navigateTo="como-chegar"
        innerText="Como Chegar?"
        selected={comoChegar}
